        ...
        <div className="max-w-[1558px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12 md:mb-16 lg:mb-20 ml-20">
            ...
            <div className="pl-4 sm:pl-5 md:pl-6">
                ...
                <p className="text-white text-xs sm:text-sm mb-8 sm:mb-10 md:mb-5 opacity-80">国内向けサービス</p>
                ...
                <div className="space-y-10 sm:space-y-12 md:space-y-16">
                  <div>
                    ...
                    <p className="text-white text-base sm:text-lg  font-bold tracking-tight">Hollywood Creative Partner</p>
            ...
            <div className="relative bg-[#111111] p-6 sm:p-8 md:p-10 lg:p-12 rounded-sm">
              ...
              <div className="pl-4 sm:pl-5 md:pl-6">
                ...
                <p className="text-white text-xs sm:text-sm mb-8 sm:mb-10 md:mb-5 opacity-80">国内外向けサービス</p>
                <div className="w-5 sm:w-6 h-[1px] bg-white mb-10"></div>
                <div className="space-y-10 sm:space-y-12 md:space-y-16">
                  <div>
                    <div className="mb-3 sm:mb-4">
                    ...
                    <p className="text-white text-base sm:text-lg  font-bold tracking-tight">Localization Suite</p>
                  ...
                  <div>
                    ...
                    <p className="text-white text-base sm:text-lg  font-bold tracking-tight">CheaBook</p>
          ...
          <div className="bg-[#111111] p-8 sm:p-12 md:p-16 rounded-sm relative overflow-hidden ml-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 md:gap-16 md:px-8 lg:px-12">
              ...
              <div className="flex flex-col items-start">
                ...
                <h4 className="text-white text-lg sm:text-xl font-bold ">Contents Marketing</h4>
              ...
              <div className="flex flex-col items-start">
                ...
                <h4 className="text-white text-lg sm:text-xl font-bold ">Creative Design</h4>
